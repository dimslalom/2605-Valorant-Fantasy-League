...
// Escalating entrance keyed by card tier — one idea, scaled, not a bespoke
// animation per tier. bronze/silver land fast and flat; gold gets a held
    ...
    case 'prestige':
      return {
        ...
        animate: {
          ...
          opacity: 1,
          transition: { duration: DUR.hero, ease: EASE.out, opacity: { duration: DUR.transform } },
        },
      };
    case 'gold':
      return {
        ...
        animate: {
          opacity: 1,
          y: 0,
          transition: { duration: DUR.enter, ease: EASE.out, delay: 0.08 },
        },
      };
    default:
      return {
